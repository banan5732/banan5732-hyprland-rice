...
hl.exec_cmd("hyprctl setcursor Remus-White 24")
-- hl.on("hyprland.start", function ()
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(3a3a3aff)", "rgba(3a3a5aff)" }, angle = 45 },
...
hl.bind(mainMod .. "+ period", hl.dsp.exec_cmd("rofimoji --selector fuzzel"))
...
--hl.bind(mainMod .. " + D", hl.dsp.window.fullscreen(), {mouse = true})
hl.bind(
	"SUPER + D",
